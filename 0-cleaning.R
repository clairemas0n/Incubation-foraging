...
# Script no 0
# The output of this first script is cleaning data 

# here I begin the process of defining a 'trip' but at the end needed to clean some trip starts and ends in excel

# I am exploring seven years of GPS data from incubating shy albatross from Albatross Island

# Last update: Dec 3, 2021 - double checking all is sweet and uploading to github 
...
# style code according to 'tidyverse' formatting, accessed via Addins dropdown menu
#install.packages("styler")
library(styler)


# load packages
library(tidyverse);library(sp);library(trip)
library(geosphere)
library(tidyr)
library(tibble)
library(sf)
...
# just appended ID750-4 2019 onto the end , didn't do excel exploration manually from scratch again
# 750_4 (2019) didn't complete a trip - last recorded location was King Island.. so this deployment doesn't have any trips to add to the dataset anyway. 
